...
ActiveRecord::Schema.define(version: 20_200_501_154_000) do
  ...
  create_table 'carts_people', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.index %w[cart_id person_id], name: 'index_carts_people_on_cart_id_and_person_id'
    t.index ['cart_id'], name: 'index_carts_people_on_cart_id'
    t.index %w[person_id cart_id], name: 'index_carts_people_on_person_id_and_cart_id'
  ...
  create_table 'carts_users', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.index %w[cart_id user_id], name: 'index_carts_users_on_cart_id_and_user_id'
    t.index ['cart_id'], name: 'index_carts_users_on_cart_id'
    t.index %w[user_id cart_id], name: 'index_carts_users_on_user_id_and_cart_id'
  ...
  create_table 'rewards', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.index %w[giftable_id giftable_type], name: 'index_rewards_on_giftable_id_and_giftable_type'
    t.index %w[giftable_type giftable_id], name: 'index_rewards_on_giftable_type_and_giftable_id'
    t.index ['person_id'], name: 'index_rewards_on_person_id'
    t.index ['reason'], name: 'gift_reason_index'
    t.index %w[rewardable_id rewardable_type], name: 'index_rewards_on_rewardable_id_and_rewardable_type'
    t.index %w[rewardable_type rewardable_id], name: 'index_rewards_on_rewardable_type_and_rewardable_id'
  ...
  create_table 'transaction_logs', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[from_id from_type], name: 'index_transaction_logs_on_from_id_and_from_type'
    t.index %w[recipient_id recipient_type], name: 'index_transaction_logs_on_recipient_id_and_recipient_type'
